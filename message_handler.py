...
from settings import TRACKED_CHANNELS, TTS_ENABLED
...
async def handle_message(message: Message, ai_service, storage_manager, tts_service=None, bot=None) -> None:
    """
    ...
    Args:
        ...
        tts_service: The TTS service instance (optional)
        bot: The Discord bot client (optional)
    """
    ...
    try:
        async with message.channel.typing():
            ...
            # Speak response in voice channel if TTS enabled
            if TTS_ENABLED and tts_service and bot and message.guild:
                from tts_service import speak_response
